...
Links:
* [Staging model in UC](https://dbc-036a17ed-a7c2.cloud.databricks.com/explore/data/models/staging/mlops_demo/mlops_demo-model)
* [Prod model in UC](https://dbc-036a17ed-a7c2.cloud.databricks.com/explore/data/models/prod/mlops_demo/mlops_demo-model)
. 
